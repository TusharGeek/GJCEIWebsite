...
const Committee = () => {
  ...
  return (
    <Box >
      <Container>
      <Text style={{fontSize:"30px",color:"#10243f",fontWeight:"700", marginTop:"40px",textAlign:"center"}}>Organizational Structure</Text>
        <Box mt={32}>
          <Paper>
            <Text>
...
<div className="grid-item">
  ...
  <div class="container">
  <Text style={{fontSize:"30px",color:"#10243f",fontWeight:"700", marginTop:"40px",textAlign:"center",marginBottom:"20px"}}>Faculty Mentors</Text>
    <div class="grid-row">
      <div class="grid-item">
      <Profile
            Img={St2}
...
<Text style={{fontSize:"30px",color:"#10243f",fontWeight:"700", marginTop:"40px",textAlign:"center",marginBottom:"20px"}}>Staff</Text>
<div className="grid-row">
<div class="grid-item">
      <Profile
        Img={St4}
